...
*/
#define     LARGE_HEAP_SIZE  (5*512) //(2*1024)
...
{ //========= pull all io to gnd by default
    ioinit_cfg_t ioInit[]= {
        ...
        {GPIO_P11,   GPIO_PULL_UP_S  },
        {GPIO_P14,   GPIO_PULL_DOWN  },
        {GPIO_P15,   GPIO_PULL_UP_S  },
        ...
        {GPIO_P31,   GPIO_PULL_UP_S  },
        {GPIO_P32,   GPIO_PULL_UP_S  },
    ...
    hal_pwrmgr_LowCurrentLdo_enable();
		...
		//hal_gpio_pin_init(GPIO_P16,GPIO_OUTPUT);  // clk i2c
	  //hal_gpio_pin_init(GPIO_P14,GPIO_OUTPUT);  // sda i2c
}
...
int  main(void)
{
    g_system_clk = 4; //SYS_CLK_DLL_64M; //SYS_CLK_XTAL_16M;//SYS_CLK_DLL_64M;
